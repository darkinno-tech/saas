...
- Renamed GoTenancy to SaaS and moved the public Go module path to `github.com/darkinno-tech/saas`.
...
- Restored ORM, framework, gRPC, and example packages to the main Go module so `go get github.com/darkinno-tech/gotenancy` provides the full package surface.
